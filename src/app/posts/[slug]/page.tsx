          ...
          <article className="flex-1 min-w-0">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              <div className="prose prose-lg max-w-none 
                ...
                prose-h2:text-xl prose-h2:mb-2 prose-h2:mt-6 prose-h2:text-blue-900
                ...
                prose-table:border-collapse prose-th:bg-gray-50 prose-th:border prose-th:border-gray-300 prose-th:p-3
